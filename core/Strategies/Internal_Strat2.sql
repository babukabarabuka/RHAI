...
INSERT OR IGNORE INTO ModifierArguments  (ModifierId, Name, Value) VALUES	
		...
		('RH_DEF',						'Amount'   , 900); -- pvs 2 Culture lol, 5, 9, 30, 20, 30, 38, 500
...
('DISTRICT_COMMERCIAL_HUB', 				'Rh_Germany_Commerical_Hub_Commer'),
...
('DISTRICT_HANSA', 					'Rh_Industrial_Zone_River_Hansa'),
('DISTRICT_HANSA', 					'Def_Industrial_Green_AQUEDUCT'),
('DISTRICT_HANSA', 					'Def_Industrial_Green_DAM'),
...
('DISTRICT_THEATER', 						'Rh_District_Theater_Wonder'), -- 100
...
('DISTRICT_AQUEDUCT', 				'Rh_Aqueduct_Strategic'),
('DISTRICT_BATH', 					'Rh_Aqueduct_Strategic'),
('DISTRICT_DAM', 					'Rh_Aqueduct_Strategic'),

('DISTRICT_AQUEDUCT', 				'Rh_Aqe_Dam'),
('DISTRICT_BATH', 					'Rh_Aqe_Dam'),

('DISTRICT_DAM', 					'Rh_Dam_Aqe'),
...
('DISTRICT_CAMPUS', 					'Rh_Campus_Reef'),
...
('DISTRICT_ENCAMPMENT', 					'Rh_Encampment_Temp'),
('DISTRICT_ENCAMPMENT', 					'Rh_Encampment_Temp2'),
('DISTRICT_ENCAMPMENT', 					'Rh_Encampment_Temp3'),

-- Gov
('DISTRICT_ENTERTAINMENT_COMPLEX', 			'Rh_Entertainment_Temp'), -- Todo prefer flat land
('DISTRICT_HOLY_SITE', 						'Rh_Holy_Site_Temp'),

-- DIPLOMATIC_QUARTER temp
('DISTRICT_ENTERTAINMENT_COMPLEX', 			'Rh_Commerical_Temp'), 
('DISTRICT_ENTERTAINMENT_COMPLEX', 			'Rh_Theater_Temp'), 
...
('DISTRICT_INDUSTRIAL_ZONE', 		'Def_Industrial_Strategic'),
...
('DISTRICT_DIPLOMATIC_QUARTER', 	'Rh_Diplo_Gov'),

('DISTRICT_GOVERNMENT', 			'Rh_Gov_City_Centre'),
('DISTRICT_GOVERNMENT', 			'Rh_Gov_Campus'),
('DISTRICT_GOVERNMENT', 			'Rh_Gov_Diplo'),
...
('Rh_District_Theater_Wonder', 							'LOC_DISTRICT_ENT_WONDER', 'YIELD_RH_PLACEMENT', 100, 1, 'TECHNOLOGY_RH_AI_MAIN', null, 1);
...
-- Aqueduct Prep
INSERT OR IGNORE INTO Adjacency_YieldChanges (ID, Description, YieldType, YieldChange, TilesRequired, PrereqTech, AdjacentResourceClass) VALUES	

('Rh_Aqueduct_Strategic',					 'LOC_DISTRICT_RH_AI_AQUEDUCT_STRATEGIC', 'YIELD_RH_PLACEMENT', 300, 1, 'TECHNOLOGY_RH_AI_MAIN', 'RESOURCECLASS_STRATEGIC');
...
('Rh_Aqe_Dam',					 'LOC_DISTRICT_RH_AI_AQE_DAM', 'YIELD_RH_PLACEMENT', 500, 1, 'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_DAM'),

('Rh_Dam_Aqe',					 'LOC_DISTRICT_RH_AI_AQE_DAM', 'YIELD_RH_PLACEMENT', 500, 1, 'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_AQUEDUCT'),


('Rh_Aqe_Industrial_Zone',					 'LOC_DISTRICT_RH_AI_AQE_INDUSTRIAL_ZONE', 'YIELD_RH_PLACEMENT', 500, 1, 'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_INDUSTRIAL_ZONE'), -- pvs 12, 18
('Rh_Dam_Industrial_Zone', 					 'LOC_DISTRICT_RH_AI_DAM_INDUSTRIAL_ZONE', 'YIELD_RH_PLACEMENT', 500, 1, 'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_INDUSTRIAL_ZONE'), -- pvs 17
('Rh_Canal_Industrial_Zone', 				 'LOC_DISTRICT_RH_AI_DAM_INDUSTRIAL_ZONE', 'YIELD_RH_PLACEMENT', 450, 1, 'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_INDUSTRIAL_ZONE'); -- pvs 17



-- 		<Row ID="Strategic_Production" Description="LOC_DISTRICT_STRATEGIC_PRODUCTION" YieldType="YIELD_PRODUCTION" YieldChange="1" TilesRequired="1" AdjacentResourceClass="RESOURCECLASS_STRATEGIC"/>


INSERT OR IGNORE INTO Adjacency_YieldChanges (ID, Description, YieldType, YieldChange, TilesRequired, PrereqTech, AdjacentResourceClass) VALUES	
('Def_Industrial_Strategic', 		 'LOC_DISTRICT_RH_AI_INDUSTRY_ENC', 'YIELD_RH_PLACEMENT', 350, 1, 	'TECHNOLOGY_RH_AI_MAIN', 		'RESOURCECLASS_STRATEGIC'); -- Encourage placement



INSERT OR IGNORE INTO Adjacency_YieldChanges (ID, Description, YieldType, YieldChange, TilesRequired, PrereqTech, AdjacentDistrict) VALUES	
-- Germany
('Rh_Germany_Commerical_Hub_Adj', 		 'LOC_DISTRICT_RH_AI_INDUSTRY_ENC', 'YIELD_RH_PLACEMENT', 950, 1, 			'TECHNOLOGY_RH_AI_GERMANY_ADJ', 'DISTRICT_HANSA'), -- pvs 3, 4, 7, 11, 240
('Rh_Germany_Commerical_Hub_Commer', 		 'LOC_DISTRICT_RH_AI_INDUSTRY_ENC', 'YIELD_RH_PLACEMENT', 450, 1, 			'TECHNOLOGY_RH_AI_GERMANY_ADJ', 'DISTRICT_COMMERCIAL_HUB'),

('Rh_Germany_Commerical_Hub_Green_AQUEDUCT', 		 'LOC_DISTRICT_RH_AI_INDUSTRY_ENC', 'YIELD_RH_PLACEMENT', 300, 1, 'TECHNOLOGY_RH_AI_GERMANY_ADJ', 'DISTRICT_AQUEDUCT'), 
('Rh_Germany_Commerical_Hub_Green_DAM', 		 'LOC_DISTRICT_RH_AI_INDUSTRY_ENC', 'YIELD_RH_PLACEMENT', 	300, 1, 	'TECHNOLOGY_RH_AI_GERMANY_ADJ', 		'DISTRICT_DAM'), 

-- Industrial Green District
('Def_Industrial_Green_AQUEDUCT', 		 'LOC_DISTRICT_RH_AI_INDUSTRY_ENC', 'YIELD_RH_PLACEMENT', 900, 1, 	'TECHNOLOGY_RH_AI_MAIN', 		'DISTRICT_AQUEDUCT'), -- Encourage placement
('Def_Industrial_Green_DAM', 		 'LOC_DISTRICT_RH_AI_INDUSTRY_ENC', 'YIELD_RH_PLACEMENT', 	900, 1, 	'TECHNOLOGY_RH_AI_MAIN', 		'DISTRICT_DAM'),   -- Encourage placement
...
-- Main Bonus
('Rh_District_Entertainment_Theater', 		 'LOC_DISTRICT_RH_AI_ENTERTAINMENT_THEATER', 'YIELD_RH_PLACEMENT', 15, 1, 'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_THEATER'), -- pvs 2, 7, 8
...
('Rh_Harbour_City_Centre',	 				'LOC_DISTRICT_RH_AI_CITY_CENTRE', 'YIELD_RH_PLACEMENT',  		950, 1, 'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_CITY_CENTER'), -- pvs 11, 14, 21, 33, 42, 650
...
('Rh_Diplo_City_Centre', 					 'LOC_DISTRICT_RH_AI_DIPLO_CITY_CENTER_GOLD', 'YIELD_RH_PLACEMENT', 250, 1,'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_CITY_CENTER'), -- total 2
('Rh_Diplo_Campus', 						 'LOC_DISTRICT_RH_AI_DIPLO_CITY_CENTER_GOLD', 'YIELD_RH_PLACEMENT', 90, 1,'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_CAMPUS'), -- pvs 4
('Rh_Diplo_Theater', 						 'LOC_DISTRICT_RH_AI_DIPLO_CITY_CENTER_GOLD', 'YIELD_RH_PLACEMENT', 50, 1,'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_THEATER'), -- pvs 1
('Rh_Diplo_Industrial', 						 'LOC_DISTRICT_RH_AI_DIPLO_CITY_CENTER_GOLD', 'YIELD_RH_PLACEMENT', 50, 1,'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_INDUSTRIAL_ZONE'),
('Rh_Diplo_Gov', 							 'LOC_DISTRICT_RH_AI_DIPLO_CITY_CENTER_GOLD', 'YIELD_RH_PLACEMENT', 250, 1,'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_GOVERNMENT'), -- Important for Internal Trade Routes

('Rh_Gov_City_Centre',						 'LOC_DISTRICT_RH_AI_GOV_CITY_CENTER_GOLD', 'YIELD_RH_PLACEMENT', 25, 1, 'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_CITY_CENTER'),
('Rh_Gov_Campus',							 'LOC_DISTRICT_RH_AI_GOV_CITY_CENTER_GOLD', 'YIELD_RH_PLACEMENT', 50, 1, 'TECHNOLOGY_RH_AI_MAIN', 	'DISTRICT_CAMPUS'),
('Rh_Gov_Diplo',							 'LOC_DISTRICT_RH_AI_GOV_CITY_CENTER_GOLD', 'YIELD_RH_PLACEMENT', 150, 1, 'TECHNOLOGY_RH_AI_MAIN', 	'DISTRICT_DIPLOMATIC_QUARTER'),

('Rh_Encampment_Temp',						 'LOC_DISTRICT_RH_AI_GOV_CITY_CENTER_GOLD', 'YIELD_RH_AT_WAR', 990, 1, 'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_GOVERNMENT'), -- pvs 175 placement, 275, 425
('Rh_Encampment_Temp2',						 'LOC_DISTRICT_RH_AI_GOV_CITY_CENTER_GOLD', 'YIELD_RH_UNDER_ATTACK', 750, 1, 'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_GOVERNMENT'), -- pvs 90, 125
('Rh_Encampment_Temp3',						 'LOC_DISTRICT_RH_AI_GOV_CITY_CENTER_GOLD', 'YIELD_RH_MILITARY_PRODUCTION', 990, 1, 'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_GOVERNMENT'), -- pvs 90, 325, 580, 950

('Rh_Entertainment_Temp',					 'LOC_DISTRICT_RH_AI_GOV_CITY_CENTER_GOLD', 'YIELD_RH_PLACEMENT', 330, 1, 'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_GOVERNMENT'), -- pvs 115 gov
('Rh_Holy_Site_Temp',					 'LOC_DISTRICT_RH_AI_GOV_CITY_CENTER_GOLD', 'YIELD_RH_PLACEMENT', 850, 1, 'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_GOVERNMENT'),

('Rh_Commerical_Temp',					 	'LOC_DISTRICT_RH_AI_GOV_CITY_CENTER_GOLD', 'YIELD_RH_PLACEMENT', 750, 1, 'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_DIPLOMATIC_QUARTER'), -- new
('Rh_Theater_Temp',					 		'LOC_DISTRICT_RH_AI_GOV_CITY_CENTER_GOLD', 'YIELD_RH_PLACEMENT', 500, 1, 'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_DIPLOMATIC_QUARTER'), -- new


('Rh_Aero_City_Centre',						'LOC_DISTRICT_RH_AI_AERODROME_CITYCENTRE', 'YIELD_RH_PLACEMENT', 75, 1, 'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_CITY_CENTER'), -- pvs 19, 40
('Rh_Spaceport_City_Centre',				'LOC_DISTRICT_RH_AI_SPACEPORT_CITYCENTRE', 'YIELD_RH_PLACEMENT', 140, 1, 'TECHNOLOGY_RH_AI_MAIN', 'DISTRICT_CITY_CENTER'), -- pvs 1, 2, 9, 25, 75
...
-- Govs 
('Rh_Gov_Coast',						 'LOC_DISTRICT_RH_AI_GOV_CITY_ADJ_TERRAIN', 'YIELD_RH_PLACEMENT', -7, 1, 'TECHNOLOGY_RH_AI_MAIN', 'TERRAIN_COAST'),
('Rh_Gov_Grass_Mountain',				 		 'LOC_DISTRICT_RH_AI_GOV_CITY_ADJ_TERRAIN', 'YIELD_RH_PLACEMENT', -1, 1, 'TECHNOLOGY_RH_AI_MAIN', 'TERRAIN_GRASS_MOUNTAIN'),
('Rh_Gov_Plains_Mountain',						 'LOC_DISTRICT_RH_AI_GOV_CITY_ADJ_TERRAIN', 'YIELD_RH_PLACEMENT', -4, 1, 'TECHNOLOGY_RH_AI_MAIN', 'TERRAIN_PLAINS_MOUNTAIN'),
('Rh_Gov_Tundra_Mountain',						 'LOC_DISTRICT_RH_AI_GOV_CITY_ADJ_TERRAIN', 'YIELD_RH_PLACEMENT', -1, 1, 'TECHNOLOGY_RH_AI_MAIN', 'TERRAIN_TUNDRA_MOUNTAIN'),
('Rh_Gov_Desert_Mountain',						 'LOC_DISTRICT_RH_AI_GOV_CITY_ADJ_TERRAIN', 'YIELD_RH_PLACEMENT', -1, 1, 'TECHNOLOGY_RH_AI_MAIN', 'TERRAIN_DESERT_MOUNTAIN'),

-- Campus Temp
('Rh_Campus_Grass_Mountain',				 		 'LOC_DISTRICT_RH_AI_GOV_CITY_ADJ_TERRAIN', 'YIELD_RH_SCIENCE_VICTORY_BASE', 300, 2, 'TECHNOLOGY_RH_AI_MAIN', 'TERRAIN_GRASS_MOUNTAIN'), -- Temp
('Rh_Campus_Plains_Mountain',						 'LOC_DISTRICT_RH_AI_GOV_CITY_ADJ_TERRAIN', 'YIELD_RH_SCIENCE_VICTORY_BASE', 300, 2, 'TECHNOLOGY_RH_AI_MAIN', 'TERRAIN_PLAINS_MOUNTAIN'),
('Rh_Campus_Tundra_Mountain',						 'LOC_DISTRICT_RH_AI_GOV_CITY_ADJ_TERRAIN', 'YIELD_RH_SCIENCE_VICTORY_BASE', 120, 2, 'TECHNOLOGY_RH_AI_MAIN', 'TERRAIN_TUNDRA_MOUNTAIN'),
('Rh_Campus_Desert_Mountain',						 'LOC_DISTRICT_RH_AI_GOV_CITY_ADJ_TERRAIN', 'YIELD_RH_SCIENCE_VICTORY_BASE', 120, 2, 'TECHNOLOGY_RH_AI_MAIN', 'TERRAIN_DESERT_MOUNTAIN'),


('Rh_Holy_Site_Grass_Mountain',				 			 'LOC_DISTRICT_RH_AI_GOV_CITY_ADJ_TERRAIN', 'YIELD_RH_RV_BASE', 60, 2, 'TECHNOLOGY_RH_AI_MAIN', 'TERRAIN_GRASS_MOUNTAIN'), -- Temp
('Rh_Holy_Site_Plains_Mountain',						 'LOC_DISTRICT_RH_AI_GOV_CITY_ADJ_TERRAIN', 'YIELD_RH_RV_BASE', 60, 2, 'TECHNOLOGY_RH_AI_MAIN', 'TERRAIN_PLAINS_MOUNTAIN'),
('Rh_Holy_Site_Tundra_Mountain',						 'LOC_DISTRICT_RH_AI_GOV_CITY_ADJ_TERRAIN', 'YIELD_RH_RV_BASE', 200, 2, 'TECHNOLOGY_RH_AI_MAIN', 'TERRAIN_TUNDRA_MOUNTAIN'),
('Rh_Holy_Site_Desert_Mountain',						 'LOC_DISTRICT_RH_AI_GOV_CITY_ADJ_TERRAIN', 'YIELD_RH_RV_BASE', 200, 2, 'TECHNOLOGY_RH_AI_MAIN', 'TERRAIN_DESERT_MOUNTAIN');
...
('Rh_Campus_Jungle',						 'LOC_DISTRICT_RH_AI_GOV_CITY_ADJ_TERRAIN', 'YIELD_RH_SCIENCE_VICTORY_BASE', 50, 3, 'TECHNOLOGY_RH_AI_MAIN', 'FEATURE_JUNGLE');
...
INSERT OR IGNORE INTO Adjacency_YieldChanges (ID, Description, YieldType, YieldChange, TilesRequired, PrereqTech, AdjacentFeature) VALUES
('Rh_Campus_Reef',							 'LOC_DISTRICT_RH_AI_GOV_CITY_ADJ_TERRAIN', 'YIELD_RH_SCIENCE_VICTORY_BASE', 400, 1, 'TECHNOLOGY_RH_AI_MAIN', 'FEATURE_REEF'),
('Rh_Campus_Fissure',						 'LOC_DISTRICT_RH_AI_GOV_CITY_ADJ_TERRAIN', 'YIELD_RH_SCIENCE_VICTORY_BASE', 400, 1, 'TECHNOLOGY_RH_AI_MAIN', 'FEATURE_GEOTHERMAL_FISSURE');
...
('Rh_All_District_Natural_Wonder_Dis',						 'LOC_DISTRICT_RH_AI_DIS_NATURAL_WONDER', 'YIELD_RH_PLACEMENT', -10, 1, 'TECHNOLOGY_RH_AI_MAIN', 1),
...
INSERT OR IGNORE INTO Adjacency_YieldChanges (ID, Description, YieldType, YieldChange, TilesRequired, PrereqTech, AdjacentFeature) VALUES
('Rh_All_District_TORRES_DEL_PAINE_Dis',						 'LOC_DISTRICT_RH_AI_DIS_NATURAL_WONDER', 'YIELD_RH_PLACEMENT', -200, 1, 'TECHNOLOGY_RH_AI_MAIN', 'FEATURE_TORRES_DEL_PAINE'); -- Double Yields


-- All District Yield Buff Wonder Super Dis

INSERT OR IGNORE INTO Adjacency_YieldChanges (ID, Description, YieldType, YieldChange, TilesRequired, PrereqTech, AdjacentFeature) VALUES
('Rh_All_District_IKKIL_pref',						 'LOC_DISTRICT_RH_AI_DIS_NATURAL_WONDER', 'YIELD_RH_PLACEMENT', 600, 1, 'TECHNOLOGY_RH_AI_MAIN', 'FEATURE_IKKIL'); -- 50% Production



INSERT OR IGNORE INTO Adjacency_YieldChanges (ID, Description, YieldType, YieldChange, TilesRequired, PrereqTech, AdjacentFeature) VALUES
('Rh_All_District_PAMUKKALE_pref',						 'LOC_DISTRICT_RH_AI_DIS_NATURAL_WONDER', 'YIELD_RH_PLACEMENT', 100, 1, 'TECHNOLOGY_RH_AI_MAIN', 'FEATURE_PAMUKKALE'); -- 50% Production
...
INSERT OR IGNORE INTO Adjacency_YieldChanges (ID, Description, YieldType, YieldChange, TilesRequired, PrereqTech, AdjacentFeature) VALUES
('Rh_Preserve_FEATURE_CHOCOLATEHILLS',						 'LOC_DISTRICT_RH_AI_PRES_NATURAL_WONDER', 'YIELD_RH_PLACEMENT', 2000, 2, 'TECHNOLOGY_RH_AI_MAIN', 'FEATURE_CHOCOLATEHILLS'),
('Rh_Preserve_FEATURE_PANTANAL',						 'LOC_DISTRICT_RH_AI_PRES_NATURAL_WONDER', 'YIELD_RH_PLACEMENT', 2000, 2, 'TECHNOLOGY_RH_AI_MAIN', 'FEATURE_PANTANAL'), 
('Rh_Preserve_FEATURE_WHITEDESERT',						 'LOC_DISTRICT_RH_AI_PRES_NATURAL_WONDER', 'YIELD_RH_PLACEMENT', 2000, 2, 'TECHNOLOGY_RH_AI_MAIN', 'FEATURE_WHITEDESERT'),

('Rh_Preserve_FEATURE_GOBUSTAN',						 'LOC_DISTRICT_RH_AI_PRES_NATURAL_WONDER', 'YIELD_RH_PLACEMENT', 2000, 2, 'TECHNOLOGY_RH_AI_MAIN', 'FEATURE_GOBUSTAN'), -- 1 Production, 3 Culture

('Rh_Preserve_FEATURE_EYE_OF_THE_SAHARA',				'LOC_DISTRICT_RH_AI_PRES_NATURAL_WONDER', 'YIELD_RH_PLACEMENT', 750, 2, 'TECHNOLOGY_RH_AI_MAIN', 'FEATURE_EYE_OF_THE_SAHARA'), -- 2 Production, 1 Science

('Rh_Preserve_FEATURE_CLIFFS_DOVER',						 'LOC_DISTRICT_RH_AI_PRES_NATURAL_WONDER', 'YIELD_RH_PLACEMENT', 2000, 2, 'TECHNOLOGY_RH_AI_MAIN', 'FEATURE_CLIFFS_DOVER'); 
...
INSERT OR IGNORE INTO Adjacency_YieldChanges (ID, Description, YieldType, YieldChange, TilesRequired, PrereqTech, AdjacentFeature) VALUES
('Rh_All_District_Volcano_Dis',						 'LOC_DISTRICT_RH_AI_DIS_NATURAL_WONDER', 'YIELD_RH_PLACEMENT', -100, 1, 'TECHNOLOGY_RH_AI_MAIN', 'FEATURE_VOLCANO'),

('Rh_All_District_Volcano_Dis_Campus',				 'LOC_DISTRICT_RH_AI_DIS_NATURAL_WONDER', 'YIELD_RH_SCIENCE_VICTORY_BASE', -300, 1, 'TECHNOLOGY_RH_AI_MAIN', 'FEATURE_VOLCANO');
...
-- Riv Goddess
('Rh_District_Riv_Goddess',					 'LOC_DISTRICT_RH_AI_RIV_GODDESS', 		'YIELD_RH_RV_BASE', 250, 1, 'TECHNOLOGY_RH_AI_RIV_GODDESS', 1), -- pvs 6, 16, 18 placement, 50 river goddess
...
('Rh_Industrial_Zone_River_Hansa',					 'LOC_DISTRICT_RH_AI_INDUSTRIAL_ZONE_RIVER_HANSA', 'YIELD_RH_PLACEMENT', 500, 1, 'TECHNOLOGY_RH_AI_GERMANY_ADJ', 1);
...
INSERT OR IGNORE INTO	ModifierArguments	(ModifierId,									Name,				Value) VALUES	
			...
			('RH_ENCAMP_TRAIN',				'Amount',					950), -- pvs 650, 650

			('RH_ENCAMP_TRAIN_L',				'GreatPersonClassType',		        'GREAT_PERSON_CLASS_GENERAL'),	
			('RH_ENCAMP_TRAIN_L',				'Amount',					1600); -- pvs 650, 1400
...
INSERT OR IGNORE INTO GreatPersonIndividualActionModifiers (GreatPersonIndividualType, ModifierId, AttachmentTargetType) VALUES	
    ('GREAT_PERSON_INDIVIDUAL_AETHELFLAED', 'RH_ENCAMP_TRAIN', 'GREAT_PERSON_ACTION_ATTACHMENT_TARGET_PLAYER'),

    ('GREAT_PERSON_INDIVIDUAL_EL_CID', 'RH_ENCAMP_TRAIN', 'GREAT_PERSON_ACTION_ATTACHMENT_TARGET_PLAYER'),

    ('GREAT_PERSON_INDIVIDUAL_GUSTAVUS_ADOLPHUS', 'RH_ENCAMP_TRAIN', 'GREAT_PERSON_ACTION_ATTACHMENT_TARGET_PLAYER'),

    ('GREAT_PERSON_INDIVIDUAL_JOAN_OF_ARC', 'RH_ENCAMP_TRAIN', 'GREAT_PERSON_ACTION_ATTACHMENT_TARGET_PLAYER'),

    ('GREAT_PERSON_INDIVIDUAL_ANA_NZINGA', 'RH_ENCAMP_TRAIN', 'GREAT_PERSON_ACTION_ATTACHMENT_TARGET_PLAYER'),

    ('GREAT_PERSON_INDIVIDUAL_NAPOLEON_BONAPARTE', 'RH_ENCAMP_TRAIN', 'GREAT_PERSON_ACTION_ATTACHMENT_TARGET_PLAYER'),

    ('GREAT_PERSON_INDIVIDUAL_RANI_LAKSHMIBAI', 'RH_ENCAMP_TRAIN', 'GREAT_PERSON_ACTION_ATTACHMENT_TARGET_PLAYER');
